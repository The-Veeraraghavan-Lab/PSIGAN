...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', type=str,default='./datasets/maps')#required=True, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--model', type=str, default='PSIGAN',help='chooses which model to use. cycle_gan, pix2pix, test')
        self.parser.add_argument('--which_direction', type=str, default='AtoB', help='AtoB or BtoA')
        self.parser.add_argument('--nThreads', default=1, type=int, help='# threads for loading data')
        self.parser.add_argument('--checkpoints_dir', type=str, default='./PSIGAN_save', help='models are saved here')
